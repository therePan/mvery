...
const URL_LOAD = ':ve.mobile.interface/resume/get_skills'
const URL_EDIT = ':ve.mobile.interface/resume/set_skill'
const URL_REMOVE = ':ve.mobile.interface/resume/delete_skill'
