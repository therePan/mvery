...
export const $ = constants('trainings', [
  'load', // 获取用户信息
  'edit', // 编辑用户信息
  'add',
  'remove',
...
const URL_LOAD = ':ve.mobile.interface/resume/get_training_exps'
const URL_EDIT = ':ve.mobile.interface/resume/set_training_exp'
const URL_REMOVE = ':ve.mobile.interface/resume/delete_training_exp'
